...
from flask import Blueprint, redirect, url_for, flash, request, render_template, send_from_directory, current_app, abort
...
def profile_picture(filename):
    ...
    public_directory = os.path.join(current_app.config['UPLOAD_FOLDER'])
